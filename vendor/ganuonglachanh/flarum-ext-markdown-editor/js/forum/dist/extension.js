      ...
      EnhancedTextEditor = (function (_TextEditor) {
        ...
        babelHelpers.createClass(EnhancedTextEditor, [{
          ...
          value: function size1() {
            this.insertAroundCursor('[size=10]', '[/size]');
          }

        }, {
          key: 'size2',
          value: function size2() {
            this.insertAroundCursor('[size=20]', '[/size]');
          }

        }, {
          key: 'size3',
          value: function size3() {
            this.insertAroundCursor('[size=30]', '[/size]');
          }

        }, {
          key: 'size4',
          value: function size4() {
            this.insertAroundCursor('[size=40]', '[/size]');
          }
          ...
          value: function colort() {
            this.insertAroundCursor('[color=#1abc9c]', '[/color]');
          } 

        }, {
          key: 'colorg',
          value: function colorg() {
            this.insertAroundCursor('[color=#2ecc71]', '[/color]');
          }

        }, {
          key: 'colorb',
          value: function colorb() {
            this.insertAroundCursor('[color=#3498db]', '[/color]');
          }

        }, {
          key: 'colorp',
          value: function colorp() {
            this.insertAroundCursor('[color=#9b59b6]', '[/color]');
          }

        }, {
          key: 'colory',
          value: function colory() {
            this.insertAroundCursor('[color=#f1c40f]', '[/color]');
          }
          ...
          value: function colorr() {
            this.insertAroundCursor('[color=#e74c3c]', '[/color]');
          }

        }, {
          key: 'colors',
          value: function colors() {
            this.insertAroundCursor('[color=#95a5a6]', '[/color]');
          }
