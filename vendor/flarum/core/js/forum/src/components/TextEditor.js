...
export default class TextEditor extends Component {
  ...
  controlItems() {
    ...
    items.add('help',Button.component({children:'帮助?',className:'Button Button--link',itemClassName:'App-primaryControl',onclick:function(){window.open(location.origin+'/p/2-edithelp')}}));
    return items;
  }
